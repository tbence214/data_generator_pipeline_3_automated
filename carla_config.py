...
class WeatherConfig:
    ...
    sun_altitude_angle: float = 60.0 # 90 is midday, 0 is the horizon, and negative values are below the horizon.
...
class SimulationConfig:
    ...
    master_seed: Optional[int] = 35
    traffic_seed: Optional[int] = 37
    ego_seed: Optional[int] = 36
    walker_seed: Optional[int] = 38
